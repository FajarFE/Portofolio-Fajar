...
const Navbar = () => {
  ...
  function handleClick() {
          ...
          >
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                ...
                <div className="hidden sm:ml-6 sm:block ">
                    ...
                    <a href="#about" className="text-white  hover:text-white px-3 py-2 text-base font-md hover:font-bold">About</a>
    ...
    <div className={`space-y-1 px-2 pt-2 pb-3 max-h-screen max-h-full`}>
      ...
      <a href="#about" className="text-gray-300 hover:font-bold hover:text-white block rounded-md px-3 py-2 text-base font-medium">About</a>
