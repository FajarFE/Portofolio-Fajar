    ...
    return (
        <>
            <div className=" w-[70%] h-auto container justify-start flex flex-col" id="contact-button">
                ...
                <form action="">
                    <label for="">
                        <span className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-white text-bold"> Send Messenger </span>
                    ...
                    <button className="w-full h-[45px] my-4 bg-[#A3F7BF] rounded-md" onClick="">
                        Send
                    </button>
                </form>
            </div>
...
const Contact =()=>{
    ...
    <div className="justify-center content-start container mx-auto " >
        ...
        <div className="flex justify-center my-10">
            <button className="bg-[#A3F7BF] w-32 h-12 text-[15px] lg:text-md md:text-[20px] text-[#1B2430] rounded-md mx-5 "id="contact-button" onClick={handleClick} >Hire Me</button>
        ...
        {button&&
       <div className="  grid grid-cols-2 gap-4 justify-center container mx-auto items-center content-center h-96 mt-32 mb-10">
