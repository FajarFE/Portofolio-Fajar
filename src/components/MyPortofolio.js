  ...
  return (
    <div className="container mx-auto pt-14">
      ...
      <div className="flex space-x-4 my-10 justify-center ">
        <button
          className={`border border-[#A3F7BF] rounded text-[15px] xs:text-[5px] sm:text-[5px]  md:text-sm lg:text-[20px] py-2 px-4 ${
        ...
        <button
          className={`border border-[#A3F7BF] rounded text-[15px] xs:text-[5px] sm:text-[5px] lg:text-[20px] py-2 px-4 md:text-sm ${
